...
namespace MyAPI
{
    ...
    public static partial class MyAPIClientExtensions
    {
            ...
            /// <param name='id'>
            /// </param>
            public static void Delete(this IMyAPIClient operations, int id)
            {
                Task.Factory.StartNew(s => ((IMyAPIClient)s).DeleteAsync(id), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this IMyAPIClient operations, int id, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// <param name='id'>
            /// </param>
            public static void GetProductItem(this IMyAPIClient operations, int id)
            {
                Task.Factory.StartNew(s => ((IMyAPIClient)s).GetProductItemAsync(id), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task GetProductItemAsync(this IMyAPIClient operations, int id, CancellationToken cancellationToken = default(CancellationToken))
            {
                await operations.GetProductItemWithHttpMessagesAsync(id, null, cancellationToken).ConfigureAwait(false);
            }
